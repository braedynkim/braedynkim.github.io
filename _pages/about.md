...
I also participated in the Northwestern CIERA REU where I analyzed galaxy FIRE-2 simulations across different evolutionary states to test predictions related to these states. I look at the difference between predicted galaxy evolution states states and prepare them for comparisons against the [MOTHRA](https://www.mothratelescope.org/) telescope, which will map out the CGM so we can test these predictions. 
